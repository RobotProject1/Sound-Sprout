...
chan3 = AnalogIn(ads2, 0)
chan4 = AnalogIn(ads2, 1)
chan5 = AnalogIn(ads2, 2)

channels = [chan0, chan1, chan2, chan3, chan4, chan5]

# Voltage-to-ID map
id2v_dict = [
    (4.10, 1), (3.87, 2), (3.67, 3), (3.59, 4),
    (3.20, 5), (2.98, 6), (2.64, 7), (2.18, 8),
    (1.99, 9), (1.75, 10), (1.50, 11), (1.15, 12)
]
